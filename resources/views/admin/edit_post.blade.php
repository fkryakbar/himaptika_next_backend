    ...
    <main>
        <div class="pt-6 px-4">
            <div class="flex justify-between items-center">
                <h1 class="font-bold text-2xl ">Edit Posts</h1>
            </div>
            <div class="mt-3">
                <form action="" method="POST" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="form-control w-full">
                        ...
                        <input type="text" value="{{ $post->title }}" name="title" placeholder="Type here"
                    ...
                    <div class="form-control w-full max-w-xs mt-3">
                        ...
                        <img src="{{ asset($post->image_path) }}" alt="selected_image">
                        <label class="label">
